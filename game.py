...
sound_manager.load_sound('gai_laser_fire', os.path.join(BASE_ASSETS_PATH, 'sounds', 'gai_laser_fire.wav'))
...
sound_manager.load_sound('gai_bullet_fire', os.path.join(BASE_ASSETS_PATH, 'sounds', 'gai_bullet_fire.wav'))
...
sound_manager.load_sound('gai_bullet_hit', os.path.join(BASE_ASSETS_PATH, 'sounds', 'gai_bullet_hit.wav'))
sound_manager.load_sound('missile_weapon_hit', os.path.join(BASE_ASSETS_PATH, 'sounds', 'missile_weapon_hit.wav'))
sound_manager.load_sound('atomic_weapon_hit', os.path.join(BASE_ASSETS_PATH, 'sounds', 'atomic_weapon_hit.wav'))
